...
type CreateCourseRequest struct {
	...
	Category     string `json:"category" binding:"required,oneof=programming design business marketing"`
...
type UpdateCourseRequest struct {
	...
	ThumbnailURL *string `json:"thumbnail_url" binding:"omitempty,url,max=255"`
	Category     *string `json:"category" binding:"omitempty,oneof=programming design business marketing"`
